...
```
[vitalii@fedora 4.2]$ python script1.py 
        изменено:      script1.py
        изменено:      script2.py
...
### Вывод скрипта при запуске при тестировании:
```
[vitalii@fedora ~]$ python script2.py ~/GIT/4.2/
/home/vitalii/GIT/4.2/
        изменено:      script1.py
        изменено:      script2.py
